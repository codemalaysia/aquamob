...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void saveUserForm(String formId,String userId,String formData){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COL_FORM_ID, formId);
        values.put(COL_USER_ID, userId);
    ...
    public ArrayList<HashMap<String,String>> getAllSavedForms(String userId){
    ...
    public ArrayList<HashMap<String,String>> getAllSavedForms(String formId,String userId){
        ArrayList<HashMap<String,String>> savedForms = new ArrayList<>();
        // Select All Query
